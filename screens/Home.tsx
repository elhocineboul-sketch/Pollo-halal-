...
const Home: React.FC<HomeProps> = ({ products, onShowSettings, onShowCart, onAddToCart, cartItemCount }) => {
  ...
  return (
    <div className="min-h-screen pb-4">
      <header className="bg-white rounded-b-3xl p-5 shadow-lg">
        <div className="flex justify-between items-center mb-5">
          ...
          <div className="text-center flex-1">
            <h1 className="text-4xl text-amber-500 font-bold">🍗 {t('appName')}</h1>
            <p className="text-base text-gray-600">{t('appTagline')}</p>
          </div>
          {/* Cart button */}
        ...
        <input
          type="text"
          className="bg-amber-500 placeholder-black placeholder-opacity-70 rounded-full py-3 px-5 border-none w-full text-lg text-end focus:outline-none focus:ring-2 focus:ring-amber-400" // Changed text-right to text-end
      ...
      <h2 className="px-5 pt-5 text-2xl font-bold text-end">{t('chickenProductsTitle')}</h2> {/* Changed text-right to text-end */}
